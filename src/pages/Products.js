...
const Products = () => {
    ...
    return (
        <motion.div 
            className="container my-5 p-4 rounded shadow-lg bg-purple"
            initial={{ opacity: 0, y: -20 }} 
            animate={{ opacity: 1, y: 0 }} 
            transition={{ duration: 0.5 }}
        >
            <h2 className="text-center text-light fw-bold mb-4">🛍 Our Products</h2>
            ...
            <div className="row">
                {products.map((p) => (
                    <div key={p.ProductID} className="col-lg-4 col-md-6 mb-4">
                        <motion.div 
                            className="card shadow-sm p-3 border-0 bg-light"
