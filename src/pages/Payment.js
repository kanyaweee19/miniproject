    ...
    return (
        ...
        >
            <h2 className="text-center text-primary fw-bold mb-4">
                💳 <span style={{ color: "#2c3e50" }}>Payment History</span> {/* เปลี่ยนเป็นสีน้ำเงินเข้ม */}
            </h2>
...
const getStatusStyle = (status) => {
    switch (status) {
        case "Completed": return { backgroundColor: "#16a085", color: "white", padding: "8px 12px", borderRadius: "5px" }; // เทาลึก
        case "Pending": return { backgroundColor: "#3498db", color: "white", padding: "8px 12px", borderRadius: "5px" }; // น้ำเงินสดใส
...
const styles = {
    ...
    paymentDetails: {
        backgroundColor: "#ecf0f1", // สีพื้นหลังเทาอ่อน
        borderRadius: "10px",
        padding: "15px",
    },
};
