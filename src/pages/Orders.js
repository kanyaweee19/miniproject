    ...
    return (
        ...
        >
            <h2 className="text-center text-primary fw-bold mb-4">
                📦 <span style={{ color: "#8a2be2" }}>Order & Payment</span> {/* เปลี่ยนเป็นสีม่วง */}
            </h2>
...
const getStatusStyle = (status) => ({
    backgroundColor: status === "Completed" ? "#8a2be2" : "#b19cd9", // เปลี่ยนเป็นสีม่วง
...
const styles = {
    ...
    orderDetails: {
        backgroundColor: "#f3e5f5", // เปลี่ยนพื้นหลังเป็นสีม่วงอ่อน
        borderRadius: "10px",
        padding: "15px",
    },
    option: {
    ...
    btnPayment: {
        backgroundColor: "#8a2be2",  // เปลี่ยนสีพื้นหลังเป็นม่วง
