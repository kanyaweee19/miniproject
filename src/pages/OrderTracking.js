    ...
    return (
        ...
        >
            <h2 className="text-center text-primary fw-bold mb-4">
                🚚 <span style={{ color: "#6a0dad" }}>Order Tracking</span> {/* เปลี่ยนเป็นสีม่วง */}
            </h2>
...
const getStatusStyle = (status) => ({
    backgroundColor: status === "Shipped" ? "#8a2be2" : "#b19cd9", // เปลี่ยนสีม่วง
...
const styles = {
    ...
    trackingDetails: {
        backgroundColor: "#f3e5f5", // เปลี่ยนสีพื้นหลังเป็นสีม่วงอ่อน
        borderRadius: "10px",
        padding: "15px",
    }
};
